                        ...
                        <div class="col-xl-9 col-md-8 col-12">
                            <div class="card invoice-preview-card">
                                ...
                                <div class="card-body invoice-padding pb-0">
                                    <div
                                        ...
                                        <div>
                                            ...
                                            <p class="card-text mb-25">{{$journal_data->address_line1}}, {{$journal_data->address_line2}}</p>
                                            <p class="card-text mb-25">{{$journal_data->city}}, {{$journal_data->state}}, {{$journal_data->country}}</p>
                                            <p class="card-text mb-0">{{$journal_data->telephone}}, {{$journal_data->mobile}}</p>
                                        </div>
                                            ...
                                            <div class="d-flex align-items-center justify-content-md-end mb-1">
                                                ...
                                                <div class="input-group input-group-merge invoice-edit-input-group">
                                                    ...
                                                    <input type="text" class="form-control invoice-edit-input"
                                                           value="{{$journal_data->stripe_invoice_id}}" />
                                                </div>
                                            </div>
                                            <div class="d-flex align-items-center mb-1">
                                                <span class="title">Date:</span>
                                                <input type="text"
                                                       class="form-control invoice-edit-input date-picker" value="{{$journal_data->stripe_invoice_issue_date}}" />
                                            </div>
                                            <div class="d-flex align-items-center">
                                                <span class="title">Due Date:</span>
                                                <input type="date"
                                                       class="form-control invoice-edit-input due-date-picker" value="{{$journal_data->stripe_invoice_due_date}}" />
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="card-body invoice-padding invoice-product-details">
                                    <form class="source-item" id="item_json" method="POST" action="/journal/store">
                                                ...
                                                <div class="row">
                                                    <div class="col-12 d-flex product-details-border position-relative pr-0">
                                                        <div class="row w-100 pr-lg-0 pr-1 py-2">
                                                            @php $json_data = json_decode($journal_data->item_json,true); @endphp
                                                            @foreach ($json_data as $key=>$item_data)
                                                                @if(is_array($item_data))

                                                            @foreach($item_data as $item_key=>$item)
                                                                        @if(is_array($item))

                                                                            @foreach($item as $json_key=>$json)
{{--                                                                                @php--}}
{{--                                                                                    print_r($json);--}}
{{--                                                                                @endphp--}}
                                                                                <p class="card-text col-title mb-md-2 ml-0">&nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp
                                                                                    Publications &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp
                                                                                    Charges &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp Qty &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp Total</p>

                                                                                @if($json_key=='PUBLICATION')
                                                                                <div class="col-lg-5 col-12 mb-lg-0 mb-2 mt-lg-0 mt-2">
                                                                                    <input type="text" class="form-control" value="{{$json}}" name="in1[index]"
                                                                                    />
                                                                                </div>
                                                                                @endif
                                                                                @if($json_key=='CHARGES')
                                                                                    <div class="col-lg-2 col-12 my-lg-0 my-2">
                                                                                        <input type="number" class="form-control" value="{{$json}}" name="in2[index]"
                                                                                        />
                                                                                    </div>
                                                                                @endif
                                                                                @if($json_key=='QUANTITY')
                                                                                    <div class="col-lg-2 col-12 my-lg-0 my-2">
                                                                                        <input type="number" class="form-control" value="{{$json}}" name="in3[index]"
                                                                                               placeholder="1" />
                                                                                    </div>
                                                                                @endif
                                                                                @if($json_key=='TOTAL')
...
{{--                                                                                        @php $total = 0; @endphp--}}
{{--                                                                                        @php $total *= $json @endphp--}}
                                                                                        <input type="number" class="form-control" value="{{$json}}" name="in4[index]"
                                                                                               placeholder="1" />
                                                                                    </div>
                                                                                @endif
                                                                            @endforeach
...
{{--                                                            <div class="dropdown">--}}
{{--                                                                <i class="cursor-pointer more-options-dropdown mr-0"--}}
{{--                                                                   data-feather="settings" role="button"--}}
{{--                                                                   id="dropdownMenuButton" data-toggle="dropdown"--}}
{{--                                                                   aria-haspopup="true" aria-expanded="false">--}}
{{--                                                                </i>--}}
{{--                                                                <div class="dropdown-menu dropdown-menu-right item-options-menu p-1"--}}
...
{{--                                                        </div>--}}
                                        ...
                                        <div class="col-12 px-0">
                                            <button type="button" class="btn btn-primary btn-sm save_json">Save Details
                                            </button>
                                        </div><br>
                                        <div class="col-12 px-0">
                                    ...
                                    <div class="row invoice-sales-total-wrapper">
                                        <div class="col-md-6 order-md-1 order-2 mt-md-0 mt-3">
                                            <div class="d-flex align-items-center mb-1">
                                                ...
                                                <input type="text" class="form-control ml-50" id="salesperson"
...
@section('page-script')
    <!-- Page js files -->
    <script src="/app-assets/js/item-json.js"></script>
