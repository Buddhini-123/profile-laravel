                ...
                <div class="sidebar">
                    <div class="sidebar-content todo-sidebar">
                        <div class="todo-app-menu">
                            <div class="add-task">
                                <a href="/course/create" class="btn btn-primary btn-block">Add Courses</a>
                            </div>
                                ...
                                <div class="list-group list-group-filters">
                                    @foreach ($course as $course)
                                        <a href="javascript:void(0)" class="list-group-item list-group-item-action">
                                            ...
                                            <span class="align-middle" id="type" data-type="{{$course->type}}"
                                                data-name="{{$course->type }}">{{ $course->type }}</span>
                                        </a>
                                    @endforeach
                                </div>
                    ...
                    <div class="content-body">
                        ...
                        <div class="todo-app-list">
                            ...
                            <div class="todo-task-list-wrapper list-group">
                                <ul class="todo-task-list media-list course-list" id="todo-task-list">
                                            ...
                                            <div class="todo-title-wrapper">
                                                <div class="todo-title-area">
                                                    ...
                                                    <div class="title-wrapper">
                                                        ...
                                                        <span class="click_category todo-title">{{ $course_data->title }}</span>
{{--                                                        <span class="click_category todo-title">{{ $course_data->detail }}</span>--}}
{{--                                                        <span class="click_category todo-title">{{ $course_data->location }}</span>--}}
{{--                                                        <span class="click_category todo-title">{{ $course_data->course_fee }}</span>--}}
                                                    </div>
                                                </div>
                                                <div class="todo-item-action">
                                                    <div class="badge-wrapper mr-1">
                                                        <input type="text" hidden id="id" name="id" value="{{$course_data->id }}">
                                                        <a href="/course/edit/{{$course_data->id }}"
                                                           class="btn btn-flat-warning waves-effect">Edit </a>
                                                    </div>
                                                    <small class="text-nowrap text-muted mr-1">{{ $course_data->dt_update }}</small>
                                                </div>
                                            </div>
                                        </li>
                                    @endforeach
