@extends('layouts.app') @section('title', 'Invoice Edit') @section('vendor-style')
                    ...
                    <div class="col-xl-9 col-md-8 col-12">
                        <div class="card invoice-preview-card">
                                    ...
                                    <div class="invoice-number-date mt-md-0 mt-2">
                                        <div class="d-flex align-items-center justify-content-md-end mb-1">
                                            ...
                                            <div class="input-group input-group-merge invoice-edit-input-group">
                                                ...
                                                <input type="text" class="form-control invoice-edit-input" value="{{$invoice->id}}" name="membership_invoice_id" placeholder="53634" />
                                            </div>
                                        </div>
                            ...
                            <div class="card-body invoice-padding invoice-product-details">
                                <div>
                                    <div class="repeater-wrapper-list"></div>
                                </div>
                            ...
                            <!-- Product Details starts -->
                            <div class="card-body invoice-padding invoice-product-details">
                                <form id="source-items-store">
                                    <div>
                                        <div class="repeater-wrapper">
                                            <div class="row item-list" data-action="new">
                                                    ...
                                                    <div class="row w-100 pr-lg-0 pr-1 py-2">
                                                        <div class="col-lg-5 col-12 mb-lg-0 mb-2 mt-lg-0 mt-2">
                                                            ...
                                                            <div class="form-group">
                                                                <select name="group[new]product" class="js-organisations-data-ajax addon-add"></select>
                                                            </div>
                                                        </div>
                                                        <div class="col-lg-3 col-12 my-lg-0 my-2">
                                                            <p class="card-text col-title mb-md-2 mb-0">Cost</p>
                                                            <input type="number" name="group[new]cost" class="form-control" value="0" readonly />
                                                        </div>
                                                        <div class="col-lg-2 col-12 my-lg-0 my-2">
                                                            <p class="card-text col-title mb-md-2 mb-0">Qty</p>
                                                            <input type="number" name="group[new]qty" class="form-control" value="0" placeholder="1" />
                                                        </div>
                                                        <div class="col-lg-2 col-12 mt-lg-0 mt-2">
                                                            <p class="card-text col-title mb-md-50 mb-0">Price</p>
                                                            <input type="number" class="form-control" name="group[new]price" value="0" readonly/>
                                                        </div>
                                                        <input type="hidden" class="form-control item-table-id" name="group[new]item_table_id" value="new" />
                                                        <input type="hidden" class="form-control" name="group[new]invoice_id" value="{{$invoice->id}}" />
                                                    </div>
                                    ...
                                    <div class="row mt-1" id="section-block">
                                        <div class="col-12 px-0">
                                            <button type="submit" class="btn btn-primary btn-sm add-new btn-section-block-multiple" data-repeater-create>
                                                <i data-feather="plus" class="mr-25"></i>
                                                <span class="align-middle">Add Item</span>
                                            </button>
                                        </div>
...
<!-- BEGIN: Page JS-->
<script src="{{asset('app-assets/js/scripts/pages/app-invoice-edit.js')}}"></script>
<!-- END: Page JS-->
