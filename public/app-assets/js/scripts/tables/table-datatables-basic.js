...
$(function () {
  ...
  var dt_basic_table = $('.datatables-basic'),
    ...
    dt_complex_header_table = $('.dt-complex-head'),
  ...
  if (dt_basic_table.length) {
    var dt_basic = dt_basic_table.DataTable({
      ...
      order: [[2, 'desc']],
      dom:
        '<"card-head border-bottom p-1"<"head-label"><"dt-action-buttons text-right"B>><"d-flex justify-content-between align-items-center mx-0 row"<"col-sm-12 col-md-6"l><"col-sm-12 col-md-6"f>>t<"d-flex justify-content-between mx-0 row"<"col-sm-12 col-md-6"i><"col-sm-12 col-md-6"p>>',
      displayLength: 7,
