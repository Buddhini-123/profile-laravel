...
(function (window, document, $) {
  ...
  $('#sidebar-page-navigation').on('click', 'a.nav-link', function (e) {
    ...
    var scrollto = offset.top - 80; // minus fixed head height
    $('html, body').animate(
      {
        scrollTop: scrollto
      },
  ...
  $(window).on('scroll', function () {
    ...
    if ($body.hasClass('navbar-static')) {
      ...
      if (scroll > 65) {
        $('html:not(.dark-layout) .horizontal-menu .head-navbar.navbar-fixed').css({
          background: '#fff',
          'box-shadow': '0 4px 20px 0 rgba(0,0,0,.05)'
        });
        $('.horizontal-menu.dark-layout .head-navbar.navbar-fixed').css({
          background: '#161d31',
          'box-shadow': '0 4px 20px 0 rgba(0,0,0,.05)'
        });
        $('html:not(.dark-layout) .horizontal-menu .horizontal-menu-wrapper.head-navbar').css('background', '#fff');
        $('.dark-layout .horizontal-menu .horizontal-menu-wrapper.head-navbar').css('background', '#161d31');
      } else {
        $('html:not(.dark-layout) .horizontal-menu .head-navbar.navbar-fixed').css({
          background: '#f8f8f8',
          'box-shadow': 'none'
        });
        $('.dark-layout .horizontal-menu .head-navbar.navbar-fixed').css({
          background: '#161d31',
          'box-shadow': 'none'
        });
        $('html:not(.dark-layout) .horizontal-menu .horizontal-menu-wrapper.head-navbar').css('background', '#fff');
  ...
  $('.nav-link-style').on('click', function () {
    ...
    // ToDo: Customizer fix
    $('.horizontal-menu .head-navbar.navbar-fixed').css({
      background: 'inherit',
      'box-shadow': 'inherit'
    });
    $('.horizontal-menu .horizontal-menu-wrapper.head-navbar').css('background', 'inherit');
  });
