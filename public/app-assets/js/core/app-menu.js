...
(function (window, document, $) {
  ...
  $.app.menu = {
    ...
    change: function (compactMenu) {
      ...
      if (currentBreakpoint.name == 'xl') {
        $('body[data-open="hover"] .main-menu-content .dropdown') // Use selector $('body[data-open="hover"] .head-navbar .dropdown') for menu and navbar DD open on hover
      ...
      if (currentBreakpoint.name == 'sm' || currentBreakpoint.name == 'xs') {
        $('.head-navbar[data-nav=brand-center]').removeClass('navbar-brand-center');
      } else {
        $('.head-navbar[data-nav=brand-center]').addClass('navbar-brand-center');
      }
    ...
    transit: function (callback1, callback2) {
      ...
      if ($body.hasClass('vertical-layout')) {
        if ($body.hasClass('menu-open') || $body.hasClass('menu-expanded')) {
          ...
          // Show menu head search when menu is normally visible
          ...
          // Hide menu head search when only menu icons are visible
          if ($body.data('menu') === 'vertical-menu') {
            if ($('.main-menu-head')) {
              $('.main-menu-head').hide();
            }
        ...
        this.transit(
          ...
          function () {
            ...
            if (
              ...
              $('.main-menu-content').css('height', $(window).height() - $('.head-navbar').height());
              // this.manualScroller.update();
            }
            if ($body.data('menu') == 'vertical-menu-modern') {
              if ($('.main-menu').hasClass('menu-fixed')) this.manualScroller.enable();
    ...
    changeMenu: function (screen) {
      ...
      if (screen === 'xl') {
        ...
        $('nav.head-navbar').removeClass('fixed-top');
        ...
        $('nav.head-navbar').addClass('fixed-top');
  ...
  $.app.nav = {
    ...
    bind_events: function () {
      ...
      $('.navigation-main')
        .on('mouseenter.app.menu', 'li', function () {
          ...
          if ($body.hasClass('menu-collapsed') && $body.data('menu') != 'vertical-menu-modern') {
            ...
            // menu_header_height = ($('.main-menu-head').length) ? $('.main-menu-head').height() : 0,
      ...
      $('.navbar-head, .main-menu').on('mouseenter', modernMenuExpand).on('mouseleave', modernMenuCollapse);

      function modernMenuExpand() {
        if ($body.data('menu') == 'vertical-menu-modern') {
          $('.main-menu, .navbar-head').addClass('expanded');
          if ($body.hasClass('menu-collapsed')) {
      ...
      function modernMenuCollapse() {
        if ($body.hasClass('menu-collapsed') && $body.data('menu') == 'vertical-menu-modern') {
          setTimeout(function () {
            if ($('.main-menu:hover').length === 0 && $('.navbar-head:hover').length === 0) {
              $('.main-menu, .navbar-head').removeClass('expanded');
              if ($body.hasClass('menu-collapsed')) {
    ...
    /* adjustSubmenu: function ($menuItem) {
      ...
      menuHeaderHeight = $('.main-menu-head').height();
      menutop = $menuItem.position().top;
      winHeight = $window.height() - $('.head-navbar').height();
      borderWidth = 0;
